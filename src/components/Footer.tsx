          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <form onSubmit={handleNewsletterSubmit} className="flex gap-2 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-64 px-4 py-2.5 rounded-xl bg-gray-900 border border-gray-700 text-white placeholder-gray-500 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
              <button
                type="submit"
                className="inline-flex items-center gap-1.5 px-5 py-2.5 bg-indigo-600 text-white rounded-xl text-sm font-semibold hover:bg-indigo-500 transition-colors"
              >
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              The AI-powered content engine that turns your posts into viral hits and publishes them everywhere.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              <li><a href="#features" className="hover:text-white transition-colors">AI Viral Rewriter</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">Multi-Platform Posting</a></li>
              <li><a href="#features" className="hover:text-white transition-colors">Viral Score</a></li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-500">
              ...
              <li>
                <button onClick={onContactSupport} className="hover:text-white transition-colors">
                  Support
                </button>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-500 text-sm">
            &copy; {new Date().getFullYear()} GoViral. All rights reserved.
          </p>
