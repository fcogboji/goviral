...
// Redirects to Ayrshare's unified linking page — no direct YouTube OAuth needed
      ...
      <html>
        <body>
          <script>
            window.opener.postMessage({ 
              type: 'PLATFORM_ERROR', 
              error: 'Failed to connect YouTube. Please use the Connect Accounts button instead.' 
            }, '${process.env.NEXT_PUBLIC_APP_URL}');
            window.close();
          </script>
        </body>
