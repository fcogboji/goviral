...
// Redirects to Ayrshare's unified linking page — no direct Instagram OAuth needed
      ...
      <html>
        <body>
          <script>
            window.opener.postMessage({ 
              type: 'PLATFORM_ERROR', 
              error: 'Failed to connect Instagram. Please use the Connect Accounts button instead.' 
            }, '${process.env.NEXT_PUBLIC_APP_URL}');
            window.close();
          </script>
        </body>
