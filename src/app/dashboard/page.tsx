...
import { Type, Image, Video, Info, LucideProps } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      <div className="p-4 sm:p-6 lg:p-8">
        <div className="w-full h-full flex flex-col gap-4 sm:gap-6">
          <h1 className="text-xl sm:text-2xl font-semibold text-gray-900 dark:text-white">Create a new post</h1>
          ...
          <div className="space-y-4 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-4">
              {postTypes.map((postType) => {
                ...
                return (
                  ...
                  >
                    <div className="card-body gap-6 sm:gap-12 pt-8 sm:pt-16 p-4 sm:p-6">
                      <div className="flex flex-col items-center text-center gap-3 sm:gap-4">
                        <IconComponent className="size-12 sm:size-16 stroke-gray-300 dark:stroke-gray-600 group-hover:stroke-blue-500 dark:group-hover:stroke-blue-400 transition-colors duration-300" strokeWidth={2} />
                        <h2 className="text-base sm:text-lg font-medium text-gray-900 dark:text-white group-hover:font-bold">
                          {postType.title}
                        </h2>
                      </div>
            ...
            {/* Connection Info */}
            <div className="flex items-start sm:items-center gap-2 text-blue-600/70 dark:text-blue-400/70">
